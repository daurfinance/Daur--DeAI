...
train_path = "ai-core/datasets/train.txt"
test_path = "ai-core/datasets/test.txt"
...
training_args = TrainingArguments(
    output_dir="ai-core/models/llama-lora-qat",
    num_train_epochs=1,
...
model.save_pretrained("ai-core/models/llama-lora-qat")
# Для экспорта в ONNX:
# torch.onnx.export(model, torch.randn(1, 128), "ai-core/models/llama-lora-qat/model.onnx")
